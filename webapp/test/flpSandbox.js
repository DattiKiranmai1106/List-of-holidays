		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktlistlistofholidays-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktlistlistofholidays-display": {
								"semanticObject": "comsapktlistlistofholidays",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.list.listofholidays",
									"url": sap.ui.require.toUrl("com/sap/kt/list/listofholidays")
								}
							}
						}
					}
